...
void inserir_na_trie(ArvoreTrie* trie, const char* palavra, uint64_t id); // Insere uma palavra na Trie com seu ID associado

char** buscar_prefixo_trie(ArvoreTrie* trie, const char* prefixo, int* quantidade);

uint64_t* buscar_ids_trie(ArvoreTrie* trie, const char* palavra, int* quantidade_ids); // Busca uma palavra exata e retorna seus IDs associados
